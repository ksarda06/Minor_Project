# chatbot_en.py
# just class definition  - it needs to be called to actually run
import pickle
import faiss
import os
...
Follow this order of questioning. Do not skip ahead. Move to the next point only when the current one is sufficiently addressed.
1.  Chief Complaint: Identify the primary problem. (e.g., "What is the main reason for your visit today?")
2.  Symptom Characterization: Explore the symptoms' onset, location, and quality. (e.g., "When did it start?" or "Can you describe the pain?")
3.  Severity & Timing: Gauge severity and frequency. (e.g., "On a scale of 1 to 10, how severe is it?" or "Is it constant or does it come and go?")
4.  Exacerbating/Relieving Factors: Identify what makes it better or worse. (e.g., "Does anything specific seem to trigger it?" or "Have you found anything that provides relief?")
5.  Current Medications & Allergies: Ask about relevant medications and allergies. (e.g., "Are you currently taking any medications?")
